...
{
    return addslashes($str); // Hapus kondisi get_magic_quotes_gpc
}
...
function get_client_ip()
{
    ...
    else if (getenv('HTTP _FORWARDED_FOR'))
...
{
    $tanggal = explode('-', $date); // Ubah split menjadi explode
