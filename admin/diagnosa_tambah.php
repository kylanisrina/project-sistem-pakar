...
if (isset($_POST['diagnosa_tambah'])) {
    ...
    if (empty($kode) || empty($nama)) {
        $error = "Field yang bertanda * tidak boleh kosong!";
...
<head>
    ...
    <title>Tambah Diagnosa | Admin</title>
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea name="keterangan" class="form-textarea" 
                              placeholder="Masukkan keterangan (opsional)"><?= isset($_POST['keterangan']) ? htmlspecialchars($_POST['keterangan']) : '' ?></textarea>
                </div>

                <div class="tombol-grup">
                    <button type="submit" name="diagnosa_tambah" class="tombol tombol-primer">
                        Simpan
                    </button>
